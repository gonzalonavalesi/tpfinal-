...
public class ComputadoraEscritorio extends Producto implements ObtenerTotal {
    ...
    public double GetTotal() {
        ...
        double precioConDescuento = valorTotal * 0.85;

        // Actualizar el precio de la computadora
